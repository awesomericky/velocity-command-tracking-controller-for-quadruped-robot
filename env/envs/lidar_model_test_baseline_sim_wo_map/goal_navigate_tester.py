...
from raisimGymTorch.env.bin import lidar_model_test_baseline_sim_wo_map
...
# create environment from the configuration file
env = VecEnv(lidar_model_test_baseline_sim_wo_map.RaisimGymEnv(home_path + "/rsc", dump(cfg['environment'], Dumper=RoundTripDumper)), cfg['environment'], normalize_ob=False)
# pdb.set_trace()
