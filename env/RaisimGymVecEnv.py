...
class RaisimGymVecEnv:
    ...
    def baseline_compute_reward(self, sampled_command, goal_Pos_local, rewards_, collision_idx,
                                steps, delta_t, must_safe_time):
        self.wrapper.baseline_compute_reward(sampled_command, goal_Pos_local, rewards_, collision_idx,
                                             steps, delta_t, must_safe_time)
        return rewards_.copy(), collision_idx.copy()
